...
class PeekClient:
    ...
    def fetch_timeslots(self, start_date="2019-08-25", end_date="2020-10-15"):
    ...
    def fetch_transactions(self, partner_id, start_date="2020-08-01", end_date="2020-08-25", page=1):
